...
# from src.utilities import RouteBuilder
#
#
...
#     for in_package in in_packages:
#         if not in_package.is_verified_address or in_package.status is not DeliveryStatus.OUT_FOR_DELIVERY:
#             return False
#     return True
#
#
...
#
#
# all_locations = RouteBuilder.all_locations
# all_packages = RouteBuilder.all_packages
#
# truck_1 = Truck(1)
# truck_2 = Truck(2)
# truck_3 = Truck(3)
